...
export const sendGenericEmail = async (
    ...
    <div style="background-color: #1a1a2e; color: #eee; font-family: 'Segoe UI', sans-serif; padding: 40px; max-width: 700px; margin: 0 auto;">
        ...
        <div style="margin-top: 20px; font-size: 11px; color: #666; text-align: center; padding-top: 15px; border-top: 1px solid #333;">
            Generated by VCB-AI Legal Intelligence | Session: ${sanitizeHtml(sessionId)}
        </div>
    </div>
    ` : `
    <div style="background-color: #000; color: #eee; font-family: sans-serif; padding: 30px; border: 1px solid #333;">
        ...
        <div style="margin-top: 40px; font-size: 12px; color: #666; border-top: 1px solid #333; padding-top: 10px;">
            Generated by VCB-AI Online | Session: ${sanitizeHtml(sessionId)}
        </div>
    </div>
    `;
