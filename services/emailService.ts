...
export const sendGenericEmail = async (
    ...
    // Wrap the raw body in a dark-mode friendly container to match the app aesthetic
    // We are hijacking the 'transcript_html' field of the existing template
    const wrappedBody = `
    <div style="background-color: #000; color: #eee; font-family: sans-serif; padding: 30px; border: 1px solid #333;">
        <h2 style="color: #fff; border-bottom: 1px solid #555; padding-bottom: 10px;">Message from ${agentName}</h2>
        ...
        <div style="margin-top: 40px; font-size: 12px; color: #666; border-top: 1px solid #333; padding-top: 10px;">
            Generated by VCB-AI Online | Session: ${sessionId}
        </div>
    </div>
    `;
    ...
    const templateParams = {
        email: toEmail,
        subject: subject,
        transcript_html: wrappedBody, // Reusing the HTML field
        duration: "N/A",
...
export const sendTranscriptEmail = async (
    ...
    dispatchLog('info', 'Dispatching to SMTP Relay via EmailJS...');
